                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><a href="<?= base_url('Operator/add_dt_ekskul') ;?>" type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp;Tambah Detail Ekskul</a></strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    <thead>
                                        <tr>
                                            <th>Id Detail Ekskul</th>
                                            <th>Nama Ekskul</th>
                                            <th>Kriteria</th>
                                            <th>Aksi</th>
                                        </tr>
                                    ...
                                    <tbody>
                                    <?php 
                                         foreach($dt_ekskul as $data):
                                         ?>
                                         <tr>
                                            <td><?= $data['id_dt_ekskul'] ;?></td>
                                            <td><?= $data['nama_ekskul'] ;?></td>
                                            <td><?= $data['nama_kriteria'] ;?></td>
                                            <td><a href="<?= base_url('Operator/edit_dt_ekskul/'.$data['id_dt_ekskul']) ;?>" type="button" class="btn btn-primary">Ubah</a><a href="<?= base_url('Operator/delete_dt_ekskul/'.$data['id_dt_ekskul']) ;?>" type="button" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                         <?php endforeach ;?>
                                    </tbody>
                                </table>
