                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><a href="<?= base_url('Operator/add_operator') ;?>" type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp; Tambah Operator</a></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php 
                                         ...
                                         <tr>
                                            ...
                                            <td><?= $data['username_operator'] ;?></td>
                                            <td><?= $data['nama_operator'] ;?></td>
                                            <td><a href="<?= base_url('Operator/edit_operator/'.$data['id_operator']) ;?>" type="button" class="btn btn-primary">Ubah</a><a href="<?= base_url('Operator/delete_operator/'.$data['id_operator']) ;?>" type="button" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                         <?php endforeach ;?>
                                    </tbody>
                                </table>
