        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="<?= base_url('Operator/store_ekskul') ;?>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                            <div class="form-group">
                                <label for="ekskul" class=" form-control-label">Nama Ekskul</label>
                                <input type="text" id="ekskul" name="ekskul" placeholder="Masukkan Nama Ekskul ..." class="form-control">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="text" id="text" cols="10" rows="10" class="form-control"></textarea>
                            </div>
                    </div>
