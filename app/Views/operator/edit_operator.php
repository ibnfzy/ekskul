        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <form action="<?= base_url('Operator/update_operator/'.$operator['id_operator']) ;?>" method="post">
                    <div class="card-body">
                            <div class="form-group">
                                <label for="username" class=" form-control-label">Username</label>
                                <input type="text" value="<?= $operator['username_operator'] ;?>" id="username" name="username" placeholder="Masukkan Username ..." class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="name" class=" form-control-label">Nama Lengkap</label>
                                <input type="text" value="<?= $operator['nama_operator'] ;?>" id="name" name="name" placeholder="Masukkan Nama Lengkap ..." class="form-control">
                            </div>
                            <div class="form-group">
