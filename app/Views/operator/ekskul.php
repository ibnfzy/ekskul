                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"><a href="<?= base_url('Operator/add_ekskul') ;?>" type="button" class="btn btn-primary"><i class="fa fa-plus-circle"></i>&nbsp; Tambah Ekskul</a></strong>
                            </div>
                            <div class="card-body">
                                    ...
                                    <tbody>
                                        <?php 
                                         ...
                                         <tr>
                                            ...
                                            <td><img src="<?= base_url('uploads/'.$data['gambar_ekskul']) ;?>" width="100"></td>
                                            <td><?= $data['ekskul'] ;?></td>
                                            <td><a href="<?= base_url('Operator/edit_ekskul/'.$data['id_ekskul']) ;?>" type="button" class="btn btn-primary">Ubah</a><a href="<?= base_url('Operator/delete_ekskul/'.$data['id_ekskul']) ;?>" type="button" class="btn btn-danger">Hapus</a></td>
                                        </tr>
                                         <?php endforeach ;?>
                                    </tbody>
                                </table>
