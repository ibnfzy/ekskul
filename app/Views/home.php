...
-->
  ...
  <body>
    <div style="opacity: 2;" class="parallax-window" data-parallax="scroll" data-image-src="<?= base_url('background.jpeg')?>">
      <div class="container-fluid">
        <div class="row tm-brand-row">
          <div class="col-lg-4 col-11">
            <div class="tm-brand-container tm-bg-white-transparent">
              <img width="150" src="<?= base_url('logo.png') ?>" alt="" srcset="">
              <div class="tm-brand-texts">
                <h1 class="text-uppercase tm-brand-name">SMK</h1>
                <p class="small">Muhammadiyah 2 Bontoala Makassar</p>
              </div>
            </div>
          </div>
              ...
              <nav class="navbar navbar-expand-lg navbar-light tm-bg-white-transparent tm-navbar">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                  <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="about.html">Info Exkul</a>
                    </li>
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                    ...
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="testimonials.html">Daftar</a>
                    </li>
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="<?= base_url('Login/login_siswa')?>">Login Siswa</a>
                    </li>
                    <li class="nav-item">
                      <div class="tm-nav-link-highlight"></div>
                      <a class="nav-link" href="<?= base_url('Login/login_operator')?>">Login Operator</a>
                    </li>
                  </ul>
                </div>
              </nav>
        ...
        <section class="row" id="tmHome">
          <div class="col-12 tm-home-container">
            ...
            <div class="tm-home-right">
              <img src="<?= base_url('img/mobile-screen.png')?>" alt="App on Mobile mockup" />
            </div>
          </div>
        </section>
        ...
        <section class="row" id="tmCallToAction">
          <div class="col-12 tm-call-to-action-col">
             <img src="<?= base_url('img/call-to-action.jpg')?>" alt="Image" class="<?= base_url('img-fluid tm-call-to-action-image')?>" /> 
